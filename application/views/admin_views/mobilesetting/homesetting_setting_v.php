        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12" > 
						...
						<a href="<?php echo base_url('admin/setting/add_mobilesetting'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Content </a> 
                            ...
                            <?php foreach ($homesetting_data as $v_info) { ?>
                                <tr>
                                    ...
                                    <td>
										...
										$action='';
                                        if ($status == 1) {
                                            echo "<a href='" . base_url('admin/setting/unpublished_mobilesetting/' . $v_info['setting_id'] . ''.$action.'?currentpage='.$currentpage.'') . "' class='btn btn-block btn-success btn-xs' data-toggle='tooltip' title='Click to unpublished'><i class='fa fa-arrow-down'></i> Published</a>";
                                        } else {
                                            echo "<a href='" . base_url('admin/setting/published_mobilesetting/' . $v_info['setting_id'] . ''.$action.'?currentpage='.$currentpage.'') . "' class='btn btn-block btn-warning btn-xs' data-toggle='tooltip' title='Click to published'><i class='fa fa-arrow-up'></i> Unpublished</a>";
                                        }
                                        ?>
                                    </td>
									
                                    <td> 									
                                        <a href="<?php echo base_url('admin/setting/edit_mobilesetting/' . $v_info['setting_id'] . ''); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a> 
										
                                        <a href="<?php echo base_url('admin/setting/remove_mobilesetting/' . $v_info['setting_id'] . '') ?>" class="btn btn-danger btn-xs check_delete" data-toggle="tooltip" title="Delete"><i class="fa fa-remove"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
