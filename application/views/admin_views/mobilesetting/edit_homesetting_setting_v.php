...
<section class="content-header">
    ...
    <ol class="breadcrumb woo-breadcrumb">
		 ...
		 <li><a class="active" href="<?php echo base_url('admin/setting/homesetting'); ?>"><i class="fa fa-file-text-o"></i>Desktop Home page</a></li> 
		 
		 <li><a class="active" href="<?php echo base_url('admin/setting/mobilesetting'); ?>"><i class="fa fa-file-text-o"></i>Api Home page</a></li> 
    </ol>
</section>
...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
      <form role="form" name="add_form" action="<?php echo base_url('admin/setting/update_mobilesetting/' . $setting_info['setting_id'] . ''); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
