...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
		...
		<form role="form" name="add_form" action="<?php echo base_url('admin/price/update_price/' . $price_info['price_id'] . ''); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input  type="text" name="price_name" value="<?php echo $price_info['price_name']; ?>" class="form-control required" id="price_name" placeholder=""> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="publication_status" class="form-control required" id="publication_status">
							...
							<option <?php if($price_info['publication_status']==1){ echo 'selected'; } ?> value="1">Published</option>
							<option <?php if($price_info['publication_status']==0){ echo 'selected'; } ?>  value="0">Unpublished</option>
						</select>
