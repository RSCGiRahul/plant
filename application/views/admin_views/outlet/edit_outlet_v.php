...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
		...
		<form role="form" name="add_form" action="<?php echo base_url('admin/outlet/update_outlet/' . $outlet_info['outlet_id'] . ''); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input  type="text" name="outlet_name" value="<?php echo $outlet_info['outlet_name']; ?>" class="form-control required" id="outlet_name" placeholder=""> 
			...
			<div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input  type="text" name="phone" value="<?php echo $outlet_info['phone']; ?>" class="form-control required" id="phone" placeholder=""> 
			...
			<div class="row">
			   <div class="col-md-6">
				  <div class="form-group">
					 ...
					 <input  type="text" name="address" value="<?php echo $outlet_info['address']; ?>" class="form-control required geo-address" id="address" placeholder=""> 
			...
			<div class="row">
			   <div class="col-md-6">
				  <div class="form-group">
					 ...
					 <input  type="text" name="assigned_city" value="<?php echo $outlet_info['assigned_city']; ?>" class="form-control required" id="assigned_city" placeholder=""> 
			...
			<div class="row">
			   <div class="col-md-6">
				  <div class="form-group">
					 ...
					 <input  type="text" name="zipcode" value="<?php echo $outlet_info['zipcode']; ?>" class="form-control required" id="zipcode" placeholder=""> 
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control m-t-xxs" id="lat" name="lat" placeholder="" value="<?php echo $outlet_info['lat']; ?>">
				</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control m-t-xxs" id="lng" name="lng" placeholder="" value="<?php echo $outlet_info['lng']; ?>">
				</div>
				</div>
			...
			<div class="row">
			   <div class="col-md-6">
				  <div class="form-group">
					 ...
					 <input  type="text" name="rating" value="<?php echo $outlet_info['rating']; ?>" class="form-control " id="rating" placeholder=""> 
			...
			<div class="row">
			   <div class="col-md-6">
				  <div class="form-group">
					 ...
					 <input  type="text" name="reviews" value="<?php echo $outlet_info['reviews']; ?>" class="form-control " id="reviews" placeholder=""> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="publication_status" class="form-control required" id="publication_status">
							...
							<option <?php if($outlet_info['publication_status']==1){ echo 'selected'; } ?> value="1">Published</option>
							<option <?php if($outlet_info['publication_status']==0){ echo 'selected'; } ?>  value="0">Unpublished</option>
						</select>
