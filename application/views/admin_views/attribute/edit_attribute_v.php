...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
		...
		<form role="form" name="add_form" action="<?php echo base_url('admin/attribute/update_attribute/' . $attribute_info['attribute_id'] . ''); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     <label for="product_name">Attribute Name</label>  
                     <input  type="text" name="attribute_name" value="<?php echo $attribute_info['attribute_name']; ?>" class="form-control required" id="attribute_name" placeholder=""> 
                     <span class="help-block error-message"><?php echo form_error('attribute_name'); ?></span>
                  </div>
               </div>
			  </div> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="publication_status" class="form-control required" id="publication_status">
							...
							<option <?php if($attribute_info['publication_status']==1){ echo 'selected'; } ?> value="1">Published</option>
							<option <?php if($attribute_info['publication_status']==0){ echo 'selected'; } ?>  value="0">Unpublished</option>
						</select>
         ...
         <div class="box-body">
            <div class="box-footer">
               <a href="<?php echo base_url('admin/attribute'); ?>" class="btn btn-danger" data-toggle="tooltip" title="Go back"><i class="fa fa-remove"></i> Cancel</a>
...
$(function() { 
        $(document).on("change", '.sortpicture14,.sortpicture2', function() {
          ...
          form_data.append('type', 'attribute');
