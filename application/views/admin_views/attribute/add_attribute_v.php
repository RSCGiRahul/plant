...
<section class="content-header">
    ...
    <ol class="breadcrumb woo-breadcrumb">
        <li><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		 <li><a class="active" href="<?php echo base_url('admin/attribute'); ?>"><i class="fa fa-cogs"></i> Manage Attributes</a></li> 
...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
      <form role="form" name="add_form" action="<?php echo base_url('admin/attribute/create_attribute'); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input  type="text" name="attribute_name" value="" class="form-control required" id="attribute_name" placeholder=""> 
