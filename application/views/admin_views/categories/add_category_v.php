...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="category_add_form" action="<?php echo base_url('admin/categories/create_category'); ?>" method="post" class="form-validation">
		...
		<h3 class="box-title">Categories Details </h3>
            ...
            <div class="box-body">
                <div class="row">
					...
					<input type="hidden" value="<?php echo $category_id; ?>" name="parent_id">
					
					
					<?php $imgid = 2; ?>
					<div class="col-md-12">  
                        <div class="form-group">
                            <label for="search_keywords">Image </label> 
					...
					?>						
					 <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">                               
                                <input type="checkbox" name="featured" value="1" <?php if(set_value('featured')==1){ echo 'checked'; } ?>  id="featured">
                            </div>
					...
					<div class="col-md-6">
                        <div class="form-group">
                            <label for="seo_title">Page Title</label>  
                                <input type="text" name="seo_title" value="<?php echo set_value('seo_title'); ?>" class="form-control required" id="seo_title" placeholder=""> 
					...
					<div class="col-md-6">
                        <div class="form-group">
                            <label for="seo_url">Friendly Title</label>  
                                <input onblur="easyFriendlyUrl(this.value, 'seo_url');" type="text" name="seo_url" value="<?php echo set_value('seo_url'); ?>" class="form-control required" id="seo_url" placeholder=""> 
