                            ...
                            <?php foreach ($categories_info as $v_category_info) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url('admin/catfilter/edit_filter/' . $v_category_info['category_id'] . ''); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
