...
<section class="content">
   <div class="box box-success">
      ...
      <!-- form start -->
		...
		<form role="form" name="add_form" action="<?php echo base_url('admin/brand/update_brand/' . $brand_info['brand_id'] . ''); ?>" method="post" class="form-validation">
         <!--- Product Details  -->
         <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input  type="text" name="brand_name" value="<?php echo $brand_info['brand_name']; ?>" class="form-control required" id="brand_name" placeholder=""> 
					...
					<div class="form-group">
					  ...
					  <span id="imagedata_<?php echo $imgid; ?>"> 
						...
						if($brand_image){
							...
							?>
							<div class="ajaximg"> <img src="<?php echo base_url()."/".$target_dir."".$brand_info['brand_image']; ?>"><a href="javascript:;" class="delete delete-img " ><i class="fa fa-times-circle" aria-hidden="true"></i></a> <input type="hidden" value="<?php echo $brand_info['brand_image']; ?>" name="brand_image"> </div>
						<?php } ?>
					  </span> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="publication_status" class="form-control required" id="publication_status">
							...
							<option <?php if($brand_info['publication_status']==1){ echo 'selected'; } ?> value="1">Published</option>
							<option <?php if($brand_info['publication_status']==0){ echo 'selected'; } ?>  value="0">Unpublished</option>
						</select>
