<div class="map-container">
                		<div class="inner-basic division-details">
                		  <div class="retailprice_<?php echo $category['product_id']; ?> hide">
                			<?php if($category['result_price_option']!=""){ ?>
                						<select class="form-control form-control-sm sm-price_option" name="price_option" product_id="<?php echo $product_id; ?>" >
                						  <?php foreach($category as $v_price_option){ 
                		  ...
                		  <div class="wholesaleprice_<?php echo $category['category_id'].'_'.$category['product_id']; ?> hide">
