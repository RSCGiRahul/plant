...
<div class="info-section new-cate 3-style">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="outer-new">
                    <div class="inner-new" style="background-image:url('<?php echo $uploaded_file_path; ?>')">
                    </div>
                    <h4><?php echo $v_category_info['category_name']; ?></h4>
