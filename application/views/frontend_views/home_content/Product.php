...
<?php foreach($category_product as $key => $categorys) {   ?>

<div class="featured-products-section carousel-section">
    <div class="container">
        <h2 class="h3 title mb-4 text-center custom-heading"><?php  echo $categorys[0]['category_name']; ?></h2>
		<div class="featured-products owl-carousel owl-theme">
		<?php
foreach($category_product[$key] as $category){
	include('vendor/_category_product.php');
} ?>
  </div>
      </div>
    <!-- End .container -->
